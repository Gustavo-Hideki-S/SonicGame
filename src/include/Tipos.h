...
typedef enum EstadoInimigoCrabmeat {
    ESTADO_INIMIGO_CRABMEAT_PARADO,
    ESTADO_INIMIGO_CRABMEAT_ANDANDO,
    ESTADO_INIMIGO_CRABMEAT_ATACANDO,
...
typedef enum EstadoInimigoBuzzbomber {
    ...
    ESTADO_INIMIGO_BUZZBOMBER_PREPARANDO_ATAQUE,
    ESTADO_INIMIGO_BUZZBOMBER_ATACANDO,
...
typedef enum {
    TIPO_ITEM_ANEL,
    TIPO_ITEM_MONITOR_INVENCIBILIDADE,
    TIPO_ITEM_MONITOR_VIDA
} TipoItem;
 ...
 */
typedef struct TiroCrabmeat {
    Rectangle ret;
    Vector2 vel;
    bool ativo;
    int quadroAtual;
    float contadorAnimacao;
} TiroCrabmeat;
...
typedef struct InimigoCrabmeat {
    ...
    float contadorEstadoAtaque;
    float duracaoEstadoAtaque;
    bool atirouNoAtaqueAtual;

    TiroCrabmeat tiros[4];
...
typedef struct InimigoBuzzbomber {
    ...
    float tempoEntreAtaques;
    float contadorEstadoAtaque;
    float duracaoPreparandoAtaque;
    float duracaoAtacando;
    bool atirouNoAtaqueAtual;

    TiroBuzzbomber tiros[4];

    Animacao *animacoes[4];
    int quantidadeAnimacoes;

    Animacao animacaoVoando;
    Animacao animacaoPreparandoAtaque;
    Animacao animacaoAtacando;
    Animacao animacaoMorrendo;
